            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-sm-6" style="height: 258px;">
                            <div class="single-gallery mt-30">
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="single-gallery mt-30">
                                <a class="image-popup" href="edumate/assets/images/gallery/8.jpg">
                                    <img src="edumate/assets/images/gallery/8.jpg" width="371" height="257" alt="gallery">
                                </a>
                            </div>
                        </div>
                        <div class="col-lg-4 col-sm-6">
                            <div class="single-gallery mt-30">
                                <a class="image-popup" href="edumate/assets/images/gallery/9.jpg">
                                    <img src="edumate/assets/images/gallery/9.jpg" width="371" height="257" alt="gallery">
                                </a>
                            </div>
                        </div>                        
