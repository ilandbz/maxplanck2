...
<html data-bs-theme="light" lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <!--    Favicons-->
    <!-- ===============================================-->
    <link rel="apple-touch-icon" sizes="180x180" href="phalcon/assets/img/favicons/apple-touch-icon.png">
    <link rel="icon" type="image/png" sizes="32x32" href="phalcon/assets/img/favicons/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="16x16" href="phalcon/assets/img/favicons/favicon-16x16.png">
    <link rel="shortcut icon" type="image/x-icon" href="phalcon/assets/img/favicons/favicon.ico">
    <link rel="manifest" href="phalcon/assets/img/favicons/manifest.json">
    <meta name="msapplication-TileImage" content="phalcon/assets/img/favicons/mstile-150x150.png">
    <meta name="theme-color" content="#ffffff">
    <script src="phalcon/assets/js/config.js"></script>
    ...
    <link href="phalcon/assets/css/theme-rtl.min.css" rel="stylesheet" id="style-rtl">
    <link href="phalcon/assets/css/theme.min.css" rel="stylesheet" id="style-default">
    <link href="phalcon/assets/css/user-rtl.min.css" rel="stylesheet" id="user-style-rtl">
    <link href="phalcon/assets/css/user.min.css" rel="stylesheet" id="user-style-default">
    <script>
  ...
  <body>
      ...
      <div class="container" data-layout="container">
          ...
          <div class="w-100">
            <div class="d-flex flex-between-center">
              ...
              <a class="navbar-brand me-1 me-sm-3" href="index-1.html">
                <div class="d-flex align-items-center"><img class="me-2" src="phalcon/assets/img/icons/spot-illustrations/falcon.png" alt="" width="40"><span class="font-sans-serif">falcon</span></div>
              </a>
                    ...
                    <div class="dropdown-menu border font-base start-0 mt-2 py-0 overflow-hidden w-100">
                      <div class="scrollbar list py-3" style="max-height: 24rem;">
                        ...
                        <h6 class="dropdown-header fw-medium text-uppercase px-x1 fs--2 pt-0 pb-2">Files</h6><a class="dropdown-item px-x1 py-2" href="#!">
                          <div class="d-flex align-items-center">
                            <div class="file-thumbnail me-2"><img class="border h-100 w-100 object-fit-cover rounded-3" src="phalcon/assets/img/products/3-thumb.png" alt=""></div>
                            <div class="flex-1">
                        ...
                        <a class="dropdown-item px-x1 py-2" href="#!">
                          <div class="d-flex align-items-center">
                            <div class="file-thumbnail me-2"><img class="img-fluid" src="phalcon/assets/img/icons/zip.png" alt=""></div>
                            <div class="flex-1">
                        ...
                        <h6 class="dropdown-header fw-medium text-uppercase px-x1 fs--2 pt-0 pb-2">Members</h6><a class="dropdown-item px-x1 py-2" href="pages/user/profile.html">
                          <div class="d-flex align-items-center">
                            <div class="avatar avatar-l status-online me-2">
                              <img class="rounded-circle" src="phalcon/assets/img/team/1.jpg" alt="">
                            </div>
                            <div class="flex-1">
                        ...
                        <a class="dropdown-item px-x1 py-2" href="pages/user/profile.html">
                          <div class="d-flex align-items-center">
                            <div class="avatar avatar-l me-2">
                              <img class="rounded-circle" src="phalcon/assets/img/team/2.jpg" alt="">
                            </div>
                            <div class="flex-1">
                        ...
                        <a class="dropdown-item px-x1 py-2" href="pages/user/profile.html">
                          <div class="d-flex align-items-center">
                            <div class="avatar avatar-l me-2">
                              <img class="rounded-circle" src="phalcon/assets/img/team/3.jpg" alt="">
                            </div>
                            <div class="flex-1">
              ...
              <ul class="navbar-nav navbar-nav-icons ms-auto flex-row align-items-center">
                        ...
                        <div class="list-group list-group-flush fw-normal fs--1">
                            ...
                            <a class="notification notification-flush notification-unread" href="#!">
                              <div class="notification-avatar">
                                <div class="avatar avatar-2xl me-3">
                                  <img class="rounded-circle" src="phalcon/assets/img/team/1-thumb.png" alt="">
                                </div>
                              </div>
                          ...
                          <div class="list-group-item">
                            <a class="notification notification-flush" href="#!">
                              <div class="notification-avatar">
                                <div class="avatar avatar-2xl me-3">
                                  <img class="rounded-circle" src="phalcon/assets/img/icons/weather-sm.jpg" alt="">
                                </div>
                              </div>
                              <div class="notification-body">
                            ...
                            <a class="border-bottom-0 notification-unread  notification notification-flush" href="#!">
                              <div class="notification-avatar">
                                <div class="avatar avatar-xl me-3">
                                  <img class="rounded-circle" src="phalcon/assets/img/logos/oxford.png" alt="">
                                </div>
                              </div>
                              <div class="notification-body">
                          ...
                          <div class="list-group-item">
                            <a class="border-bottom-0 notification notification-flush" href="#!">
                              <div class="notification-avatar">
                                <div class="avatar avatar-xl me-3">
                                  <img class="rounded-circle" src="phalcon/assets/img/team/10.jpg" alt="">
                                </div>
                              </div>
                              <div class="notification-body">
                        ...
                        <div class="card-body px-3">
                          <div class="row text-center gx-0 gy-0">
                            <div class="col-4"><a class="d-block hover-bg-200 px-2 py-3 rounded-3 text-center text-decoration-none" href="pages/user/profile.html" target="_blank">
                                <div class="avatar avatar-2xl"> <img class="rounded-circle" src="phalcon/assets/img/team/3.jpg" alt=""></div>
                                <p class="mb-0 fw-medium text-800 text-truncate fs--2">Account</p>
                              </a></div>
                            <div class="col-4"><a class="d-block hover-bg-200 px-2 py-3 rounded-3 text-center text-decoration-none" href="https://themewagon.com/" target="_blank"><img class="rounded" src="phalcon/assets/img/nav-icons/themewagon.png" alt="" width="40" height="40">
                                <p class="mb-0 fw-medium text-800 text-truncate fs--2 pt-1">Themewagon</p>
                              </a></div>
                            <div class="col-4"><a class="d-block hover-bg-200 px-2 py-3 rounded-3 text-center text-decoration-none" href="https://mailbluster.com/" target="_blank"><img class="rounded" src="phalcon/assets/img/nav-icons/mailbluster.png" alt="" width="40" height="40">
                                <p class="mb-0 fw-medium text-800 text-truncate fs--2 pt-1">Mailbluster</p>
                              </a></div>
                            <div class="col-4"><a class="d-block hover-bg-200 px-2 py-3 rounded-3 text-center text-decoration-none" href="#!" target="_blank"><img class="rounded" src="phalcon/assets/img/nav-icons/google.png" alt="" width="40" height="40">
                                <p class="mb-0 fw-medium text-800 text-truncate fs--2 pt-1">Google</p>
                              </a></div>
                            <div class="col-4"><a class="d-block hover-bg-200 px-2 py-3 rounded-3 text-center text-decoration-none" href="#!" target="_blank"><img class="rounded" src="phalcon/assets/img/nav-icons/spotify.png" alt="" width="40" height="40">
                                <p class="mb-0 fw-medium text-800 text-truncate fs--2 pt-1">Spotify</p>
                              </a></div>
                            <div class="col-4"><a class="d-block hover-bg-200 px-2 py-3 rounded-3 text-center text-decoration-none" href="#!" target="_blank"><img class="rounded" src="phalcon/assets/img/nav-icons/steam.png" alt="" width="40" height="40">
                                <p class="mb-0 fw-medium text-800 text-truncate fs--2 pt-1">Steam</p>
                              </a></div>
                            <div class="col-4"><a class="d-block hover-bg-200 px-2 py-3 rounded-3 text-center text-decoration-none" href="#!" target="_blank"><img class="rounded" src="phalcon/assets/img/nav-icons/github-light.png" alt="" width="40" height="40">
                                <p class="mb-0 fw-medium text-800 text-truncate fs--2 pt-1">Github</p>
                              </a></div>
                            <div class="col-4"><a class="d-block hover-bg-200 px-2 py-3 rounded-3 text-center text-decoration-none" href="#!" target="_blank"><img class="rounded" src="phalcon/assets/img/nav-icons/discord.png" alt="" width="40" height="40">
                                <p class="mb-0 fw-medium text-800 text-truncate fs--2 pt-1">Discord</p>
                              </a></div>
                            <div class="col-4"><a class="d-block hover-bg-200 px-2 py-3 rounded-3 text-center text-decoration-none" href="#!" target="_blank"><img class="rounded" src="phalcon/assets/img/nav-icons/xbox.png" alt="" width="40" height="40">
                                <p class="mb-0 fw-medium text-800 text-truncate fs--2 pt-1">xbox</p>
                              </a></div>
                            <div class="col-4"><a class="d-block hover-bg-200 px-2 py-3 rounded-3 text-center text-decoration-none" href="#!" target="_blank"><img class="rounded" src="phalcon/assets/img/nav-icons/trello.png" alt="" width="40" height="40">
                                <p class="mb-0 fw-medium text-800 text-truncate fs--2 pt-1">Kanban</p>
                              </a></div>
                            <div class="col-4"><a class="d-block hover-bg-200 px-2 py-3 rounded-3 text-center text-decoration-none" href="#!" target="_blank"><img class="rounded" src="phalcon/assets/img/nav-icons/hp.png" alt="" width="40" height="40">
                                <p class="mb-0 fw-medium text-800 text-truncate fs--2 pt-1">Hp</p>
                              </a></div>
                            <div class="col-12">
                              <hr class="my-3 mx-n3 bg-200">
                            </div>
                            <div class="col-4"><a class="d-block hover-bg-200 px-2 py-3 rounded-3 text-center text-decoration-none" href="#!" target="_blank"><img class="rounded" src="phalcon/assets/img/nav-icons/linkedin.png" alt="" width="40" height="40">
                                <p class="mb-0 fw-medium text-800 text-truncate fs--2 pt-1">Linkedin</p>
                              </a></div>
                            <div class="col-4"><a class="d-block hover-bg-200 px-2 py-3 rounded-3 text-center text-decoration-none" href="#!" target="_blank"><img class="rounded" src="phalcon/assets/img/nav-icons/twitter.png" alt="" width="40" height="40">
                                <p class="mb-0 fw-medium text-800 text-truncate fs--2 pt-1">Twitter</p>
                              </a></div>
                            <div class="col-4"><a class="d-block hover-bg-200 px-2 py-3 rounded-3 text-center text-decoration-none" href="#!" target="_blank"><img class="rounded" src="phalcon/assets/img/nav-icons/facebook.png" alt="" width="40" height="40">
                                <p class="mb-0 fw-medium text-800 text-truncate fs--2 pt-1">Facebook</p>
                              </a></div>
                            <div class="col-4"><a class="d-block hover-bg-200 px-2 py-3 rounded-3 text-center text-decoration-none" href="#!" target="_blank"><img class="rounded" src="phalcon/assets/img/nav-icons/instagram.png" alt="" width="40" height="40">
                                <p class="mb-0 fw-medium text-800 text-truncate fs--2 pt-1">Instagram</p>
                              </a></div>
                            <div class="col-4"><a class="d-block hover-bg-200 px-2 py-3 rounded-3 text-center text-decoration-none" href="#!" target="_blank"><img class="rounded" src="phalcon/assets/img/nav-icons/pinterest.png" alt="" width="40" height="40">
                                <p class="mb-0 fw-medium text-800 text-truncate fs--2 pt-1">Pinterest</p>
                              </a></div>
                            <div class="col-4"><a class="d-block hover-bg-200 px-2 py-3 rounded-3 text-center text-decoration-none" href="#!" target="_blank"><img class="rounded" src="phalcon/assets/img/nav-icons/slack.png" alt="" width="40" height="40">
                                <p class="mb-0 fw-medium text-800 text-truncate fs--2 pt-1">Slack</p>
                              </a></div>
                            <div class="col-4"><a class="d-block hover-bg-200 px-2 py-3 rounded-3 text-center text-decoration-none" href="#!" target="_blank"><img class="rounded" src="phalcon/assets/img/nav-icons/deviantart.png" alt="" width="40" height="40">
                ...
                <li class="nav-item dropdown"><a class="nav-link pe-0 ps-2" id="navbarDropdownUser" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <div class="avatar avatar-xl">
                      <img class="rounded-circle" src="phalcon/assets/img/team/3-thumb.png" alt="">
                    </div>
                  </a>
        ...
        <nav class="navbar navbar-light navbar-vertical navbar-expand-xl" style="display: none;">
          ...
          <div class="d-flex align-items-center">
            ...
            </div><a class="navbar-brand" href="index-1.html">
              <div class="d-flex align-items-center py-3"><img class="me-2" src="phalcon/assets/img/icons/spot-illustrations/falcon.png" alt="" width="40"><span class="font-sans-serif">falcon</span></div>
            </a>
          </div>
              ...
              <div class="settings mb-3">
                <div class="card shadow-none">
                  <div class="card-body alert mb-0" role="alert">
                    ...
                    <div class="text-center"><img src="phalcon/assets/img/icons/spot-illustrations/navbar-vertical.png" alt="" width="80">
        ...
        <div class="content">
              ...
              <div class="card h-md-100">
                ...
                <div class="card-body pt-2">
                  <div class="row g-0 h-100 align-items-center">
                    <div class="col">
                      <div class="d-flex align-items-center"><img class="me-3" src="phalcon/assets/img/icons/weather-icon.png" alt="" height="60">
                        <div>
          ...
          <div class="row g-0">
            ...
            <div class="col-lg-6 col-xl-5 col-xxl-4 mb-3 ps-lg-2">
              <div class="card h-lg-100">
                <div class="bg-holder bg-card" style="background-image:url(phalcon/assets/img/icons/spot-illustrations/corner-1.png);"></div>
                <!--/.bg-holder-->
                    ...
                    <table class="table table-dashboard mb-0 table-borderless fs--1 border-200">
                      ...
                      <tbody>
                        <tr class="border-bottom border-200">
                          <td>
                            <div class="d-flex align-items-center position-relative"><img class="rounded-1 border border-200" src="phalcon/assets/img/products/12.png" width="60" alt="">
                        ...
                        <tr class="border-bottom border-200">
                          <td>
                            <div class="d-flex align-items-center position-relative"><img class="rounded-1 border border-200" src="phalcon/assets/img/products/10.png" width="60" alt="">
                              <div class="flex-1 ms-3">
                        ...
                        <tr class="border-bottom border-200">
                          <td>
                            <div class="d-flex align-items-center position-relative"><img class="rounded-1 border border-200" src="phalcon/assets/img/products/11.png" width="60" alt="">
                              <div class="flex-1 ms-3">
                        ...
                        <tr class="border-bottom border-200">
                          <td>
                            <div class="d-flex align-items-center position-relative"><img class="rounded-1 border border-200" src="phalcon/assets/img/products/14.png" width="60" alt="">
                              <div class="flex-1 ms-3">
                        ...
                        <tr>
                          <td>
                            <div class="d-flex align-items-center position-relative"><img class="rounded-1 border border-200" src="phalcon/assets/img/products/13.png" width="60" alt="">
                              <div class="flex-1 ms-3">
              ...
              <div class="card">
                ...
                <div class="card-body pb-0">
                  <div class="d-flex mb-3 hover-actions-trigger align-items-center">
                    <div class="file-thumbnail"><img class="border h-100 w-100 object-fit-cover rounded-2" src="phalcon/assets/img/products/5-thumb.png" alt=""></div>
                    <div class="ms-3 flex-shrink-1 flex-grow-1">
                      ...
                      <div class="hover-actions end-0 top-50 translate-middle-y"><a class="btn btn-light border-300 btn-sm me-1 text-600" data-bs-toggle="tooltip" data-bs-placement="top" title="Download" href="phalcon/assets/img/icons/cloud-download.svg" download="download"><img src="phalcon/assets/img/icons/cloud-download.svg" alt="" width="15"></a><button class="btn btn-light border-300 btn-sm me-1 text-600 shadow-none" type="button" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"><img src="phalcon/assets/img/icons/edit-alt.svg" alt="" width="15"></button></div>
                    </div>
                  </div>
                  <hr class="text-200">
                  <div class="d-flex mb-3 hover-actions-trigger align-items-center">
                    <div class="file-thumbnail"><img class="border h-100 w-100 object-fit-cover rounded-2" src="phalcon/assets/img/products/3-thumb.png" alt=""></div>
                    <div class="ms-3 flex-shrink-1 flex-grow-1">
                  ...
                  <hr class="text-200">
                  <div class="d-flex mb-3 hover-actions-trigger align-items-center">
                    <div class="file-thumbnail"><img class="img-fluid" src="phalcon/assets/img/icons/zip.png" alt=""></div>
                    <div class="ms-3 flex-shrink-1 flex-grow-1">
                  ...
                  <hr class="text-200">
                  <div class="d-flex mb-3 hover-actions-trigger align-items-center">
                    <div class="file-thumbnail"><img class="border h-100 w-100 object-fit-cover rounded-2" src="phalcon/assets/img/products/2-thumb.png" alt=""></div>
                    <div class="ms-3 flex-shrink-1 flex-grow-1">
                  ...
                  <hr class="text-200">
                  <div class="d-flex mb-3 hover-actions-trigger align-items-center">
                    <div class="file-thumbnail"><img class="img-fluid" src="phalcon/assets/img/icons/docs.png" alt=""></div>
                    <div class="ms-3 flex-shrink-1 flex-grow-1">
                ...
                <div class="card-body py-2">
                  ...
                  <div class="d-flex align-items-center position-relative mb-3">
                    <div class="avatar avatar-2xl status-offline">
                      <img class="rounded-circle" src="phalcon/assets/img/team/4.jpg" alt="">
                    </div>
                    <div class="flex-1 ms-3">
                  ...
                  <div class="d-flex align-items-center position-relative false">
                    <div class="avatar avatar-2xl status-offline">
                      <img class="rounded-circle" src="phalcon/assets/img/team/5.jpg" alt="">
                    </div>
                    <div class="flex-1 ms-3">
            ...
            <div class="col-sm-6 col-xxl-3 ps-sm-2 order-xxl-1 mb-3 mb-xxl-0">
              <div class="card h-100">
                ...
                <div class="card-body d-flex flex-center flex-column">
                  ...
                  <!-- If you are not using gulp based workflow, you can find the transpiled code at: public/phalcon/assets/js/theme.js-->
    ...
    <div class="offcanvas offcanvas-end settings-panel border-0" id="settings-offcanvas" tabindex="-1" aria-labelledby="settings-offcanvas">
      ...
      <div class="offcanvas-body scrollbar-overlay px-x1 h-100" id="themeController">
        ...
        <div class="btn-group d-block w-100 btn-group-navbar-style">
          <div class="row gx-2">
            <div class="col-6"><input class="btn-check" id="themeSwitcherLight" name="theme-color" type="radio" value="light" data-theme-control="theme"><label class="btn d-inline-block btn-navbar-style fs--1" for="themeSwitcherLight"> <span class="hover-overlay mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0" src="phalcon/assets/img/generic/falcon-mode-default.jpg" alt=""></span><span class="label-text">Light</span></label></div>
            <div class="col-6"><input class="btn-check" id="themeSwitcherDark" name="theme-color" type="radio" value="dark" data-theme-control="theme"><label class="btn d-inline-block btn-navbar-style fs--1" for="themeSwitcherDark"> <span class="hover-overlay mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0" src="phalcon/assets/img/generic/falcon-mode-dark.jpg" alt=""></span><span class="label-text"> Dark</span></label></div>
          </div>
        </div>
        <hr>
        <div class="d-flex justify-content-between">
          <div class="d-flex align-items-start"><img class="me-2" src="phalcon/assets/img/icons/left-arrow-from-left.svg" width="20" alt="">
            <div class="flex-1">
        ...
        <hr>
        <div class="d-flex justify-content-between">
          <div class="d-flex align-items-start"><img class="me-2" src="phalcon/assets/img/icons/arrows-h.svg" width="20" alt="">
            <div class="flex-1">
        ...
        <hr>
        <div class="d-flex align-items-start"><img class="me-2" src="phalcon/assets/img/icons/paragraph.svg" width="20" alt="">
          <div class="flex-1">
        ...
        <div class="btn-group d-block w-100 btn-group-navbar-style">
          <div class="row gx-2">
            <div class="col-6"><input class="btn-check" id="navbar-style-transparent" type="radio" name="navbarStyle" value="transparent" data-theme-control="navbarStyle"><label class="btn d-block w-100 btn-navbar-style fs--1" for="navbar-style-transparent"> <img class="img-fluid img-prototype" src="phalcon/assets/img/generic/default.png" alt=""><span class="label-text"> Transparent</span></label></div>
            <div class="col-6"><input class="btn-check" id="navbar-style-inverted" type="radio" name="navbarStyle" value="inverted" data-theme-control="navbarStyle"><label class="btn d-block w-100 btn-navbar-style fs--1" for="navbar-style-inverted"> <img class="img-fluid img-prototype" src="phalcon/assets/img/generic/inverted.png" alt=""><span class="label-text"> Inverted</span></label></div>
            <div class="col-6"><input class="btn-check" id="navbar-style-card" type="radio" name="navbarStyle" value="card" data-theme-control="navbarStyle"><label class="btn d-block w-100 btn-navbar-style fs--1" for="navbar-style-card"> <img class="img-fluid img-prototype" src="phalcon/assets/img/generic/card.png" alt=""><span class="label-text"> Card</span></label></div>
            <div class="col-6"><input class="btn-check" id="navbar-style-vibrant" type="radio" name="navbarStyle" value="vibrant" data-theme-control="navbarStyle"><label class="btn d-block w-100 btn-navbar-style fs--1" for="navbar-style-vibrant"> <img class="img-fluid img-prototype" src="phalcon/assets/img/generic/vibrant.png" alt=""><span class="label-text"> Vibrant</span></label></div>
          </div>
        </div>
        <div class="text-center mt-5"><img class="mb-4" src="phalcon/assets/img/icons/spot-illustrations/47.png" alt="" width="120">
    ...
    <script src="phalcon/assets/js/theme.js"></script>
  </body>
