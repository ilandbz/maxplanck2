...
const {
    errors, respuesta, carpetaPopup, subirImagen,
    eliminarImagen
} = usePopup();
...
const guardarImagen = async() => {
    ...
    formData.append('popup_id', form.value.popup_id);
    ...
    if(respuesta.value.ok==1){
        ...
        emit('cargarImagenes', form.value.popup_id)
    }
}
const eliminar = (id) => {
        Swal.fire({
                        ...
                        <div class="col-md-12 mb-1">
                            ...
                            <tbody>
                                <tr v-for="(imagen,index) in imagenes" :key="imagen.id">
                                    <td>{{ index + 1 }}</td>
                                    <td><div style="max-width: 120px;"><img class="img-fluid" :src="carpetaPopup + imagen.nombreImagen"></div></td>
                                    <td>
